...
EXTERN  FUNC(void, GLOBAL) processEdges(P2CONST(int, DEVICE) adjMatrix, P2VAR(int, DEVICE) shortestDistances, P2VAR(int, DEVICE) updateShortestDistances,
								P2VAR(int, DEVICE) processedVertices, P2CONST(int, DEVICE) numVertices);
EXTERN  FUNC(void, GLOBAL) relaxEdges(P2CONST(int, DEVICE) adjMatrix, P2VAR(int, DEVICE) shortestDistances, P2VAR(int, DEVICE) updateShortestDistances,
								P2VAR(int, DEVICE) processedVertices, P2CONST(int, DEVICE) numVertices); 
EXTERN  FUNC(int, HOST) allVerticesProcessed(P2CONST(int, HOST) processedVertices, P2CONST(int, HOST) numVertices);
EXTERN  FUNC(void, HOST) Dijkstra(P2CONST(int, HOST) adjMatrix, P2VAR(int, HOST) shortestDistances, P2VAR(int, HOST) updateShortestDistances,
								P2VAR(int, HOST) processedVertices, P2CONST(int, HOST) numVertices, CONSTVAR(int, HOST) testCaseNumber);
